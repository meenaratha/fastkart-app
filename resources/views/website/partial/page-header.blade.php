                        ...
                        <li class="right-nav-list">
                            <div class="dropdown theme-form-select">
                                <button class="btn dropdown-toggle" type="button" id="select-language"
                                    ...
                                    <img src="{{ asset('website/assets/images/country/united-states.png')}}"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="select-language">
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0)" id="english">
                                            <img src="{{ asset('website/assets/images/country/united-kingdom.png')}}"
                                                class="img-fluid blur-up lazyload" alt="">
                                            <span>English</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0)" id="france">
                                            <img src="{{ asset('website/assets/images/country/germany.png')}}"
                                                class="img-fluid blur-up lazyload" alt="">
                                            <span>Germany</span>
                                        </a>
                                    </li>
                ...
                <div class="col-12">
                    <div class="navbar-top">
                        ...
                        <a href="index-2.html" class="web-logo nav-logo">
                            <img src="{{ asset('website//assets/images/logo/1.png')}}" class="img-fluid blur-up lazyload" alt="">
                        </a>
...
<!--sticky menu end-->
<!-- menus start-->
<div class="container-fluid-lg" style="padding-top: 10px;">
    <div class="row">
        <div class="col-12">
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="index-3.html">Sweetshop</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="index-4.html">Organic</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="index-5.html">Supershop</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="index-6.html">Classic shop</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="index-7.html">Furniture</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="index-8.html">Search Oriented</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="index-9.html">Category Focus</a>
                                            </li>
                                            <li>
...
<div class="mobile-menu d-md-none d-block mobile-cart">
    <ul>
        ...
        <li>
            <a href="cart.html">
                <i class="fa-solid fa-bag-shopping" style="color:#fff;"></i>
                <span>Cart</span>
            </a>
        </li>
    </ul>
